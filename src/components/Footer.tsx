    ...
    <footer className="bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <h3 className="text-2xl font-bold mb-6 gradient-text">Columbia Accounting & Tax</h3>
            <p className="text-gray-400 mb-6">
              A full-service accounting firm licensed in Maryland, providing professional, personalized services for business owners, executives, and independent professionals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-gray-400">5921 Norway Ct</li>
              <li className="text-gray-400">Columbia, MD 21044</li>
              <li className="text-gray-400">Phone: (443) 741-1970</li>
              <li className="text-gray-400">Fax: (410) 807-8398</li>
              <li className="text-gray-400">Email: accounting@cataxservices.net</li>
            </ul>
          </div>
        </div>
        
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© 2025 Columbia Accounting & Tax Services. All rights reserved.</p>
