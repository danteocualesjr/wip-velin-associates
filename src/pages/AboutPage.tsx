          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Geety, Blair & Associates, P.A. is a full-service accounting firm with over 100 years of combined experience providing expert financial services.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Founded with a vision to provide exceptional accounting services to businesses and individuals, Geety, Blair & Associates has grown to become a trusted name in the financial industry.
                </p>
                <p className="text-gray-600 mb-4">
